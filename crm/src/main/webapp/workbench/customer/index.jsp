				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="edit-customerName" value="myCompanny">
							</div>
						</div>
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.jsp';">myCompanny</a></td>
							<td>zhangsan</td>
							<td>010-84846003</td>
